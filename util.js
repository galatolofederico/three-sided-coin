...
function getRandomNumber(min, max) {
 ...
 function shape2mesh(body){
    var solidMaterial =new THREE.MeshPhongMaterial( { color: 0x888888 } );
    var wireframe = true
    ...
    for (var l = 0; l < body.shapes.length; l++) {
        ...
        case CANNON.Shape.types.PLANE:
            ...
            var ground = new THREE.Mesh( geometry, new THREE.MeshLambertMaterial( { color: 0x777777}) );
